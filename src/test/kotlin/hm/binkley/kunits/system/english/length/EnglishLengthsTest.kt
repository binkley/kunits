...
internal class EnglishLengthsTest {
    ...
    fun `should convert`() {
        ...
        assertEquals(1L.poppyseeds.to(Barleycorns), (1 over 4).barleycorns)
        ...
        assertEquals(1L.barleycorns.to(Barleycorns), 1.barleycorns)
        ...
        assertEquals(1L.inches.to(Barleycorns), 3.barleycorns)
        ...
        assertEquals(1L.sticks.to(Barleycorns), 6.barleycorns)
        ...
        assertEquals(1L.hands.to(Barleycorns), 12.barleycorns)
        ...
        assertEquals(1L.feet.to(Barleycorns), 36.barleycorns)
        ...
        assertEquals(1L.yards.to(Barleycorns), 108.barleycorns)
